...
1. Что такое Foundry? Какое его главное отличие от hardhat?
2. Как подключить Foundry для тестирования контракта? Что нужно импортировать?
3. Какой префикс должен быть у функций в тестах чтобы они считались тестами?
4. Какое главное условие успешного выполнения теста? Как нужно поменять название тестовой функции, чтобы ревертнуя функция давала успешный результат теста и является ли это best practice? Почему?
5. Какой патерн наименования тестовой функции нужно использовать по best practice?
6. Будет ли протестирована функция если указать ее видимость как internal или private?
7. Можно ли использовать абстрактные контракты как вспомогательные контракты для хранения функций и переменных применяемые при тестированиии? Как это сделать?
8. Что делает функция setUp()? Она обязательная?
9. Что такое Forge Std библиотека? Для чего она нужна?
10. Что такое cheatcode и для чего они нужны?
 ...
 - Как проверить что метод генерирует ивент?
11. Можно ли использовать console.log?
12. Как можно сделать трассировки для неудачных тестов? А как для всех?
13. Поддерживает ли Foundry Fork testing? Какие есть способы? 
14. Что такое Fuzz Testing? Для чего это может быть полезно?
16. Что такое Invariant Testing?
17. Что такое Differential Testing?
