...
4. Какие есть способы именования тестовых функций?
5. Будет ли протестирована функция если указать ее видимость как internal или private?
6. Можно ли использовать вспомогательные контракты для хранения функций и переменных применяемые при тестированиии? Как это сделать?
7. Что делает функция setUp()? Она обязательная?
8. Что такое cheatcode и для чего они нужны?
